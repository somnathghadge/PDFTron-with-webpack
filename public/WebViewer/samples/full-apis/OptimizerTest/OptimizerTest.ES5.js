      ...
      r(2)(function() {
        ...
        ? function(t, n) {
            for (var r = u(t), f = arguments.length, a = 1, s = o.f, l = i.f; f > a; )
              for (var p, h = c(arguments[a++]), v = s ? e(h).concat(s(h)) : e(h), y = v.length, d = 0; y > d; ) l.call(h, (p = v[d++])) && (r[p] = h[p]);
            return r;
          }
        : f;
  },
    ...
    var o = r(1),
      ...
      $ = function(t, n, r) {
        return (
          ...
          (n = w(n, !0)),
          b(r),
          i(W, n) ? (r.enumerable ? (i(t, R) && t[R][n] && (t[R][n] = !1), (r = O(r, { enumerable: _(0, !1) }))) : (i(t, R) || I(t, R, _(1, {})), (t[R][n] = !0)), Y(t, n, r)) : I(t, n, r)
        );
      },
      K = function(t, n) {
        b(t);
    ...
    G ||
      (f(
        (N = function() {
          ...
          return u && V && Y(U, t, { configurable: !0, set: n }), H(t);
        }).prototype,
        'toString',
        function() {
          return this._k;
