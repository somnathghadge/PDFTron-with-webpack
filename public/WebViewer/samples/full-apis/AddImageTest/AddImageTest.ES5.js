  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, g, d) {
      ...
      if (
        ...
        if (((m = { values: _ ? F : S('values'), keys: g ? F : S('keys'), entries: M }), d)) for (x in m) x in P || i(P, x, m[x]);
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var b, S = '', w = 0, _ = 0; _ < m.length; _++) {
            x = m[_];
            for (var E = String(x[0]), P = f(s(u(x.index), h.length), 0), O = [], F = 1; F < x.length; F++) O.push(void 0 === (b = x[F]) ? b : String(b));
            var M = x.groups;
            if (p) {
