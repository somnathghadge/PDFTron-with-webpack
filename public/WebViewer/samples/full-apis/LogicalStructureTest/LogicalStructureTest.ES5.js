  ...
  function(t, n, r) {
    ...
    if (u.ABV) {
      ...
      (x = function(t) {
        ...
        (_ = function(t, n, r) {
          s(this, _, 'DataView'), s(t, x, 'DataView');
          var e = t[T],
            o = l(n);
        ...
        o && (V(x, 'byteLength', '_l'), V(_, 'buffer', '_b'), V(_, 'byteLength', '_l'), V(_, 'byteOffset', '_o')),
        a(_.prototype, {
          getInt8: function(t) {
    ...
    d(x, 'ArrayBuffer'), d(_, 'DataView'), c(_.prototype, u.VIEW, !0), (n.ArrayBuffer = x), (n.DataView = _);
  },
  function(t, n) {
    var r = (t.exports = 'undefined' != typeof window && window.Math == Math ? window : 'undefined' != typeof self && self.Math == Math ? self : Function('return this')());
    'number' == typeof __g && (__g = r);
